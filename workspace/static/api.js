overlay.addEventListener('change', updateImage);
channel.addEventListener('input', updateImage);
contrast.noUiSlider.on("change", () => { updateImage(); });
overlay_slider.noUiSlider.on("change", () => { updateImage(); });
...
function updateImage() {
    ...
    fetchImageUpdate("/channel", params);
}
